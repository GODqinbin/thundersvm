...
#build/bin/thundersvm-train -c 100 -g 0.125 /data/dataset/rcv1_train.binary > log/rcv1.log
...
build/bin/thundersvm-train -c 10 -g 0.125 /data/dataset/mnist.binary > log/mnist.binary.log
